...
export const TIMELINE_ITEMS: TimelineItem[] = [
  ...
  },
  {
    ...
    },
    {
      ...
      name: 'Operation Fishbowl - Johnston Atoll, Pacific',
      type: 'event',
      layer: 'government-conspiracies',
      start: 1962,
      ...
      source: 'Defense Atomic Support Agency Reports / Fringe Cosmology Literature'
    },
    {
      id: 'gateway-process',
    ...
    {
      id: 'naca-founded-event',
      name: 'NACA Founded',
      type: 'event',
      layer: 'nasa-space',
      start: 1915,
      description: 'The National Advisory Committee for Aeronautics (NACA) is founded to undertake, promote, and institutionalize aeronautical research in the United States, later transitioning into NASA in 1958.',
      source: 'National Advisory Committee for Aeronautics Charter'
    },
    {
    ...
    },
{
    ...
    {
      id: 'og-bashan',
      name: 'King Og of Bashan',
      type: 'lifespan',
      layer: 'ancient-civilizations',
      start: -1450,
      end: -1406,
      description: 'The giant Amorite King of Bashan, who was the last of the remnant of the Rephaim. Defeated by Moses, he is famously recorded for his legendary size and his nine-cubit-long iron bedstead.',
    ...
    {
      id: 'sihon',
      name: 'King Sihon of the Amorites',
      type: 'lifespan',
      layer: 'ancient-civilizations',
      start: -1450,
      end: -1406,
      description: 'The giant King of the Amorites who ruled from Heshbon. He refused to let the Israelites pass through his land and was defeated at the Battle of Jahaz.',
      source: 'Numbers 21, Deuteronomy 2, Free The Rabbits Podcast',
      isPeopleGroup: true,
      subLabel: 'Possible Nephilim Bloodline'
    },
    {
      ...
      description: 'An ancient tribe of giants inhabiting the region of Ham. Defeated by Chedorlaomer in the War of the Kings, they are commonly identified with the Zamzummim.',
    ...
    },
    {
      ...
      description: 'The legendary giant progenitor of the Anakim and founder of Kiriath-Arba (Hebron), described as the greatest man among the Anakim.',
    ...
    },
    {
      ...
      description: 'The giant ancestor and progenitor of the famous Philistine giant clans of Gath, whose descendants included Goliath and several other giant warriors.',
    ...
    },
    {
      ...
      description: 'An ancient Canaanite people group described in Amos 2:9 as possessing height like the height of the cedars and strength like the oaks.',
    ...
    },
    {
      ...
      layer: 'ancient-civilizations',
      start: -1010,
      description: 'The champion giant of Gath, standing over nine feet tall. Defeated by young David with a sling and a stone, representing the defeat of the final giant strongholds in Canaan.',
      source: '1 Samuel 17, Free The Rabbits Podcast',
      isPeopleGroup: true,
      subLabel: 'Possible Nephilim Bloodline'
    },
    {
      ...
      description: 'The legendary giant progenitor of the Anakim and son of Arba. He established the lineage of giants that dominated Hebron and the hill country of Canaan.',
      source: 'Numbers 13:22, Joshua 15:13, Free The Rabbits Podcast',
      isPeopleGroup: true,
      subLabel: 'Possible Nephilim Bloodline'
    },
    {
      id: 'sons-of-anak',
      name: 'Sons of Anak (Ahiman, Sheshai, Talmai)',
      type: 'lifespan',
      layer: 'ancient-civilizations',
      start: -1500,
      end: -1406,
      description: 'The three giant rulers of Hebron descended from Anak. They terrified the ten Israelite spies and were eventually dispossessed by Caleb during the conquest.',
      source: 'Numbers 13:22, Joshua 15:14, Free The Rabbits Podcast',
      isPeopleGroup: true,
      subLabel: 'Possible Nephilim Bloodline'
    },
    {
      id: 'giants-of-gath',
      name: 'Giants of Gath (Ishbi-Benob, Saph, Lahmi)',
      type: 'lifespan',
      layer: 'ancient-civilizations',
      start: -1010,
      end: -970,
      description: 'The giant descendants of Rapha who fought in the Philistine armies. They were slain in battles by King David and his mighty men.',
      source: '2 Samuel 21:16-22, 1 Chronicles 20:4-8, Free The Rabbits Podcast',
      isPeopleGroup: true,
      subLabel: 'Possible Nephilim Bloodline'
    },
    {
      ...
      description: 'The twin giant sons of the Watcher Semjaza mentioned in the Book of Giants. Famous for their symbolic nightmares warning of the coming global cataclysm.',
      source: 'Book of Giants, Free The Rabbits Podcast',
      isPeopleGroup: true,
      subLabel: 'Possible Nephilim Bloodline'
    },
    {
      id: 'mahway-messenger',
      name: 'Mahway the Giant Messenger',
      type: 'lifespan',
      layer: 'ancient-civilizations',
      start: -3000,
      end: -2348,
      description: 'A pre-Flood giant son of Barakel who acted as an envoy, flying to Enoch to seek interpretation of the giant brothers\' prophetic nightmares.',
      source: 'Book of Giants, Free The Rabbits Podcast',
      isPeopleGroup: true,
      subLabel: 'Possible Nephilim Bloodline'
    }
...
// Biblical Patriarchs (Figures)
  ...
  'og-bashan': { lng: 36.1030, lat: 32.6140, locationName: "Kingdom of Bashan (King Og's Stronghold)", category: 'Giants & Nephilim' },
  'sihon': { lng: 35.8110, lat: 31.8310, locationName: "City of Heshbon (King Sihon's Capital)", category: 'Giants & Nephilim' },
  'zuzim': { lng: 35.8500, lat: 32.2200, locationName: 'Ham (Zuzim Stronghold)', category: 'Giants & Nephilim' },
  'arba': { lng: 35.0998, lat: 31.5298, locationName: 'Kiriath-Arba (Hebron)', category: 'Giants & Nephilim' },
  'rapha': { lng: 34.8500, lat: 31.7000, locationName: 'Gath (Rapha Stronghold)', category: 'Giants & Nephilim' },
  'amorite-giants': { lng: 35.6000, lat: 31.9000, locationName: 'Amorite Giant Territories', category: 'Giants & Nephilim' },
  'goliath': { lng: 34.8467, lat: 31.6997, locationName: 'Gath (Tel es-Safi)', category: 'Giants & Nephilim' },
  'anak-giant': { lng: 35.0998, lat: 31.5298, locationName: 'Kiriath-Arba (Hebron)', category: 'Giants & Nephilim' },
  'sons-of-anak': { lng: 35.0998, lat: 31.5298, locationName: 'Hebron (Kiriath-Arba)', category: 'Giants & Nephilim' },
  'giants-of-gath': { lng: 34.8500, lat: 31.7000, locationName: 'Valley of Rephaim / Gath', category: 'Giants & Nephilim' },
  'ohyah-hahyah': { lng: 35.4597, lat: 31.7411, locationName: 'Qumran Caves (Book of Giants Discovery)', category: 'Giants & Nephilim' },
  'mahway-messenger': { lng: 35.4597, lat: 31.7411, locationName: 'Qumran Caves (Book of Giants Discovery)', category: 'Giants & Nephilim' },
  // Future Prophecies
  ...
  'project-mkultra': { lng: -77.164, lat: 38.948, locationName: 'Langley, Virginia', category: 'Government Conspiracies' },
  'project-stargate': { lng: -76.741, lat: 39.113, locationName: 'Fort Meade, Maryland', category: 'Government Conspiracies' },
  'operation-paperclip': { lng: -86.586, lat: 34.730, locationName: 'Huntsville, Alabama', category: 'Government Conspiracies' },
  'project-blue-book': { lng: -84.054, lat: 39.814, locationName: 'Wright-Patterson AFB, Ohio', category: 'Government Conspiracies' },
  'majestic-12': { lng: -77.036, lat: 38.907, locationName: 'Washington D.C.', category: 'Government Conspiracies' },
  'operation-northwoods': { lng: -77.036, lat: 38.907, locationName: 'Washington D.C. (Pentagon)', category: 'Government Conspiracies' },
  'montauk-project': { lng: -71.864, lat: 41.062, locationName: 'Camp Hero, Montauk, New York', category: 'Government Conspiracies' },
  'philadelphia-experiment': { lng: -75.174, lat: 39.897, locationName: 'Philadelphia Naval Shipyard', category: 'Government Conspiracies' },
  'operation-mockingbird': { lng: -77.036, lat: 38.907, locationName: 'Washington D.C. (CIA HQ / Media Hubs)', category: 'Government Conspiracies' },
  'operation-sea-spray': { lng: -122.419, lat: 37.774, locationName: 'San Francisco, California', category: 'Government Conspiracies' },
  'project-sunshine': { lng: -87.629, lat: 41.878, locationName: 'Chicago, Illinois (Argonne National Lab)', category: 'Government Conspiracies' },
  'project-horizon': { lng: -86.640, lat: 34.681, locationName: 'Redstone Arsenal, Alabama', category: 'Government Conspiracies' },
  'project-iceworm': { lng: -61.137, lat: 77.178, locationName: 'Camp Century, Greenland', category: 'Government Conspiracies' },
  'project-plowshare': { lng: -116.046, lat: 37.136, locationName: 'Nevada Test Site', category: 'Government Conspiracies' },
  'project-1794': { lng: -79.638, lat: 43.684, locationName: 'Malton, Ontario, Canada', category: 'Government Conspiracies' },
  'operation-gladio': { lng: 12.496, lat: 41.902, locationName: 'Rome, Italy (NATO Command)', category: 'Government Conspiracies' },
  'operation-lac': { lng: -90.199, lat: 38.627, locationName: 'St. Louis, Missouri (Core Test Area)', category: 'Government Conspiracies' },
  'operation-chase': { lng: -76.008, lat: 36.850, locationName: 'Atlantic Ocean (Out of Norfolk, VA)', category: 'Government Conspiracies' },
  'operation-highjump': { lng: 135.0, lat: -82.8628, locationName: 'Ross Ice Shelf, Antarctica', category: 'Government Conspiracies' },
  ...
  'kumburgaz-ufo': { lng: 28.468, lat: 41.034, locationName: 'Kumburgaz (Sea of Marmara, Turkey)', category: 'Alien Sightings' },
  'skinny-bob': { lng: -93.7502, lat: 32.5252, locationName: 'Twelve Mile Bayou / Shreveport, Louisiana', category: 'Alien Sightings' },
  'anomaly-UFO-1007': { lng: 31.2464, lat: -17.8928, locationName: 'Ariel School (Ruwa, Zimbabwe)', category: 'Alien Sightings' },
  'alien-sighting-ariel-school-1994': { lng: 31.2464, lat: -17.8928, locationName: 'Ariel School (Ruwa, Zimbabwe)', category: 'Alien Sightings' },
  'anomaly-UFO-1008': { lng: 5.9839, lat: 43.8378, locationName: 'Valensole (Alpes-de-Haute-Provence, France)', category: 'Alien Sightings' },
  'alien-sighting-valensole-1965': { lng: 5.9839, lat: 43.8378, locationName: 'Valensole (Alpes-de-Haute-Provence, France)', category: 'Alien Sightings' },
  'alien-sighting-socorro-1964': { lng: -106.8978, lat: 34.0425, locationName: 'Socorro (New Mexico)', category: 'Alien Sightings' },
  'alien-sighting-socorro-1964-node': { lng: -106.8978, lat: 34.0425, locationName: 'Socorro (New Mexico)', category: 'Alien Sightings' },
  'alien-sighting-nazca-tridactyl-2017': { lng: -74.9328, lat: -14.8359, locationName: 'Nazca & Palpa (Ica Region, Peru)', category: 'Alien Sightings' },
  'alien-sighting-nazca-tridactyl-node': { lng: -74.9328, lat: -14.8359, locationName: 'Nazca & Palpa (Ica Region, Peru)', category: 'Alien Sightings' },
  'abduction-hill-1961': { lng: -71.6841, lat: 44.0855, locationName: 'Lincoln (White Mountains, New Hampshire)', category: 'Alien Abductions' },
  ...
  'operation-fishbowl': { lng: -169.5292, lat: 16.7375, locationName: 'Johnston Atoll, Pacific Ocean', category: 'Government Conspiracies' },
  'gateway-process': { lng: -78.5085, lat: 38.0293, locationName: 'The Monroe Institute (Faber, Virginia)', category: 'Government Conspiracies' },
  'kandahar-giant-event': { lng: 65.7372, lat: 31.6289, locationName: 'Kandahar Cave (Kandahar, Afghanistan)', category: 'Government Conspiracies' },
  'ahnenerbe-founded': { lng: 13.4050, lat: 52.5200, locationName: 'Ahnenerbe Headquarters (Berlin, Germany)', category: 'Government Conspiracies' },
  'die-glocke-development': { lng: 16.5011, lat: 50.6278, locationName: 'Wenceslaus Mine (Ludwikowice Kłodzkie, Poland)', category: 'Government Conspiracies' },
  'deep-freeze-expedition': { lng: 0.0, lat: -90.0, locationName: 'Amundsen-Scott South Pole Station (Antarctica)', category: 'Government Conspiracies' },
  'project-pegasus-event': { lng: -122.3321, lat: 47.6062, locationName: 'Seattle Portal Station (Seattle, Washington)', category: 'Government Conspiracies' },
  ...
  'naca-founded-event': { lng: -76.3814, lat: 37.0872, locationName: 'Langley Memorial Aeronautical Laboratory (Hampton, VA)', category: 'NASA / Space' },
  ...
  'project-sun-streak-event': { lng: -76.7325, lat: 39.1118, locationName: 'Fort Meade (Maryland, USA)', category: 'Government Conspiracies' },
  ...
  'cern-lhc-startup-event': { lng: 6.0557, lat: 46.2330, locationName: 'CERN Large Hadron Collider (Geneva, Switzerland)', category: 'Particle Accelerators' },
  'ssc-abandonment-event': { lng: -96.8486, lat: 32.3951, locationName: 'Superconducting Super Collider Tunnels (Waxahachie, USA)', category: 'Particle Accelerators' },
  ...
  'bill-cooper': { lng: -109.2909, lat: 34.1112, locationName: 'Eagar, Arizona', category: 'Government Conspiracies' },
  'behold-pale-horse': { lng: -109.2909, lat: 34.1112, locationName: 'Eagar, Arizona', category: 'Government Conspiracies' },
  'vatican-observatory': { lng: -109.8920, lat: 32.7016, locationName: 'Mount Graham, Arizona', category: 'NASA / Space' },
  'haarp-facility': { lng: -145.1502, lat: 62.3934, locationName: 'Gakona, Alaska', category: 'Government Conspiracies' },
